    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="d-block w-100" src="<?php echo base_url('assets/img/OIG (1).jpg') ?>" alt="First slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo base_url('assets/img/OIG (2).jpg') ?>" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo base_url('assets/img/OIG.jpg') ?>" alt="Third slide">
            </div>
        </div>
...
<br>
<h5 class="ml-4" style="color: gray; font-family: Arial, Helvetica, sans-serif; font-style: oblique;">Kategori :
    Tas & Aksesoris</h5>

<div class="row text-center mt-4 ml-3">
    <?php foreach ($tasAksesoris as $brg) : ?>
