    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo base_url('assets/img/OIG (4).jpg') ?>" alt="Second slide">
            </div>
            <div class="carousel-item">
                <img class="d-block w-100" src="<?php echo base_url('assets/img/OIG (5).jpg') ?>" alt="Third slide">
            </div>
        </div>
    ...
    <div id="container">
        <div class="row text-center mt-4">
            ...
            <div class="card ml-3 mb-3" style="width: 16rem;">
                <img class="card-img-top" src="<?php echo base_url() . '/upload/' . $brg->gambar ?>"
